              ...
              <form className="form-inline my-2 my-lg-0">
                ...
                <li className="nav-item dropdown active f_r"   style={{marginRight:"50px"}}>
                  ...
                  <div className="dropdown-menu" aria-labelledby="navbarDropdown"  style={{fontSize:"16px",backgroundColor:"#0C3B2E"}}>
                    ...
                    <a   className="dropdown-item" href="/admin/trivias">Trivias</a>
                    <a   className="dropdown-item" href="/admin/articles">Articles</a>
                  </div>
                </li>
               
                <li className="nav-item active" style={{marginRight:"50px"}}>
                  <a className="nav-link button-yellow" href=" javascript:localStorage.clear();window.location.href='/admin' "style={{marginTop:"4px",textAlign:"center"}}>
                    SIGN OUT
                  </a>
